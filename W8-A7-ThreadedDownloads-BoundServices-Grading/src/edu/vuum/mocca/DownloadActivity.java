...
public class DownloadActivity extends DownloadBase {
    ...
    ServiceConnection mServiceConnectionAsync = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName name,
                ...
                mDownloadRequest = edu.vuum.mocca.DownloadRequest.Stub.asInterface(service);
            }
        ...
        case R.id.bound_sync_button:
            ...
            new AsyncTask<Uri, Void, String>() {
                ...
                protected String doInBackground(Uri... uris) {
                    ...
                    try {
                        imagePathname = mDownloadCall.downloadImage(uris[0]);
                ...
                protected void onPostExecute(String imagePathname) {
                    ...
                    // Check for null if foInBackground() failed
