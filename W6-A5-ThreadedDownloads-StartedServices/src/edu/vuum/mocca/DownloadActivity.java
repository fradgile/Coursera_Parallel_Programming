...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
            ...
            startService(DownloadUtils.makeMessengerIntent(this, DownloadIntentService.class, handler, this.getUrlString()));                        
            break;
        ...
        case R.id.thread_pool_button:
            ...
            startService(DownloadUtils.makeMessengerIntent(this, ThreadPoolDownloadService.class, handler, this.getUrlString()));                        
            break;
